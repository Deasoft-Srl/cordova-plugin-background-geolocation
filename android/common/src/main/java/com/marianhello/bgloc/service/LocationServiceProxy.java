...
public class LocationServiceProxy implements LocationService, LocationServiceInfo {
    ...
    public void configure(Config config) {
        ...
        // FIXES:
        // https://github.com/progamma/react-native-background-geolocation/issues/360
        // https://github.com/progamma/cordova-plugin-background-geolocation/issues/551
        // https://github.com/progamma/cordova-plugin-background-geolocation/issues/552
        if (!isStarted()) { return; }
